...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
        <img src="{{ asset('img/icons') }}/si.png" alt="laravel Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">SISFO UINAM</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.divisi.index') }}"
                        class="nav-link {{ Request::segment(2) == 'divisi' ? 'active' : '' }}">
                        <i class="nav-icon far fa-circle"></i>
                        <p>
                            Divisi Pengurus
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.pengurus.index') }}"
                        class="nav-link {{ Request::segment(2) == 'pengurus' ? 'active' : '' }}">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                            Pengurus
                        </p>
