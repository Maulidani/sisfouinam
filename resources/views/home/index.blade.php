...
@section('content')
    ...
    <div class="regular-page-area section-padding-100 mt-5 mb-4">
        <div class="col-lg-9 mx-auto">
            <div class="card">
                <div class="card-header">SISFO UINAM</div>
                <div class="card-body">
                    <p class="lead">
                        Website ini ditujukan untuk peminat IT sebagai sumber informasi seputar teknologi. Konten - konten
                        yang ada di website ini antara lain berisi berbagai artikel dan
                        kegiatan-kegiatan yang diadakan oleh HMJ - SI </p>
                </div>
            </div>
        </div>
    </div>
    ...
    @if ($agenda->count() > 0)
        <!-- ##### Artikel ##### -->
        <section class="blog-area" style="margin-top: 50px; margin-bottom:70px;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-heading">
                    ...
                    @foreach ($agenda as $ag)
                        <div class="col-md-6 mb-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img src="{{ asset('uploads/img/agenda/' . $ag->thumbnail) }}" width="100%"
                                        style="height: 300px; object-fit: cover; object-position: center;">
                                    ...
                                    <a href="{{ route('agenda.show', $ag->slug) }}"
                                        class="btn btn-primary btn-sm">Selengkapnya</a>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                ...
                <div class="row mt-3">
                    <a href="{{ route('agenda') }}" class="alert alert-success alert-link mx-auto mt-3">Lihat Semua
                        Agenda</a>
                </div>
            </div>
        </section>
